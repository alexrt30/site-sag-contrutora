...
float: right; } nav.site-header.after-scroll-wrap .site-header-category-links a { margin-left: 25px; margin-right: 0px; } nav.site-header.after-scroll-wrap .site-header-category-links li > ul li a{ padding-left: 0px; }';
	...
	//3. blog section 
	echo '.vc_theme_blog_post_holder.body-content .entry-content .latest_post_date i, .body-content .blog .entry-meta i{ color:'.esc_attr(($lipi_theme_options['blog-meta-icon-color']['regular']!=""?$lipi_theme_options['blog-meta-icon-color']['regular']:'#ffaa00')).'!important; }';
	/** WOO **/
